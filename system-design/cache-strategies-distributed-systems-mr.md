...
रात्रीचे ११:५९ वाजले आहेत.  
जगभरातील लाखो प्रेक्षक एका लोकप्रिय मालिकेचा शेवटचा भाग बघण्यासाठी आतुरतेने वाट पाहत आहेत.  
घड्याळ मध्यरात्र दाखवते.  
सर्वजण एकाच वेळी **"Play"** बटण दाबतात.  
Netflix चा कॅश — जो गेल्या एक तासापासून आनंदाने data serve करत होता — अचानक expire होतो.  
प्रत्येक server ताज्या data साठी database कडे धाव घेतो.  
Database गुदमरतो.  
App मंदावतो.  
Twitter तक्रारींनी भरून जातो.

या प्रकाराला एक नाव आहे.  
इंजिनिअर्स याला **Thundering Herd Problem** म्हणतात.  
आणि मूलभूत TTL कॅशिंग देखील ही समस्या निर्माण करण्यास मदत करते..

मुळात, कॅशिंग सोपे वाटते:  
एकदा काहीतरी मोजा,  
​​निकाल टाइम-टू-लाइव्ह (TTL) सह संग्रहित करा,  
कॅशेमधून ते जलद सर्व्ह करा आणि ते कालबाह्य झाल्यावर ते पुन्हा मोजा.  
सोपे. स्वच्छ. सुंदर.

**जोपर्यंत ते तसे राहते.**

वितरित प्रणालींमध्ये -  
जिथे हजारो users शेकडो servers वर एकत्र येतात -  
साधं caching, caching नसण्यापेक्षा जास्त धोकादायक ठरू शकते.  
हा ब्लॉग तुम्हाला त्या battle-tested धोरणांमध्ये घेऊन जातो,  
ज्या Netflix, Amazon आणि Hotstar सारख्या कंपन्या  
traffic spikes दरम्यान त्यांच्या प्रणाली जिवंत ठेवण्यासाठी वापरतात.

---

## १. मूळ TTL Caching पुरेसे का नाही

Caching म्हणजे संगणकशास्त्रातील सर्वात जुन्या युक्त्यांपैकी एक.  
कल्पना सुंदर आहे: वारंवार तीच गोष्ट compute किंवा fetch करण्याऐवजी,  
ती कुठेतरी जलद ठिकाणी (जसे RAM मध्ये) साठवा आणि पुन्हा वापरा.

TTL (Time-To-Live) cached data ला स्वयंचलितपणे स्वच्छ करतो.  
तुम्ही एक timer सेट करता —  
समजा ५ मिनिटे —  
आणि त्यानंतर data जुना मानला जातो व काढून टाकला जातो.  
पुढील request ताजी fetch trigger करते.

> 🚀 **अचंबित करणारी गोष्ट:** RAM मधून data access करायला ~१०० nanoseconds लागतात. Network वरून database मधून fetch करायला ~१० milliseconds लागतात. हा **१,००,००० पट वेगाचा फरक** आहे.
...
> ⚠️ **कठोर सत्य:** सामान्य traffic दरम्यान तुमचे रक्षण करणारा cache, traffic spike दरम्यान नुकसान *वाढवू* शकतो. उत्पादनातील साधं TTL caching चा हाच विरोधाभास आहे.
...
एक लोकप्रिय IPL सामना कल्पना करा.  
Hotstar ने सर्व ५ कोटी प्रेक्षकांसाठी live score cache केला आहे.  
TTL १० सेकंदांवर सेट आहे.  
बरोबर T=१० सेकंदांनी, **सर्वांसाठी** cache expire होतो.  
सर्व ५ कोटी clients एकाच वेळी database server ला updated scores साठी request पाठवतात.

Database एका क्षणात ५ कोटी queries ची भिंत बघतो.  
तो यासाठी तयार नव्हता.  
तो गुडघ्यांवर पडतो.  
**थंडरिंग हर्ड** मध्ये आपले स्वागत आहे.

थंडरिंग हर्ड समस्या तेव्हा उद्भवते जेव्हा सामायिक cache expiry नंतर मोठ्या संख्येने  
processes किंवा requests एकत्रितपणे trigger होतात.  
वितरित प्रणालींमध्ये, यामुळे संपूर्ण database clusters कोलमडू शकतात.
...
> 📊 **वास्तविक आकडे:** Amazon Prime Day 2023 दरम्यान, Amazon ने ४८ तासांत **३७.५ कोटींहून अधिक वस्तूंची विक्री** हाताळली. बुद्धिमान caching शिवाय, प्रति request ०.०१ सेकंदाचाही विलंब अब्जावधी डॉलर्सच्या महसूल नुकसानात cascade होईल. Cache धोरण हे फक्त developer ची चिंता नाही — ते व्यवसाय टिकण्याची गरज आहे.

मूळ समस्या म्हणजे **temporal correlation**:  
खूप जास्त cache entries एकच expiry timestamp वापरतात.  
हे किराणा दुकानातील सर्व दूधाच्या पिशव्यांची expiry date एकच असण्यासारखे आहे —  
जेव्हा त्या एकत्र खराब होतात, तेव्हा कितीही restocking केले तरी पुरत नाही.
...
Synchronized expiry वरील उपाय अत्यंत सोपा आहे:  
**सर्व गोष्टी एकाच वेळी expire होऊ देऊ नका.**

प्रत्येक cache entry ला बरोबर ३०० सेकंदांचा TTL सेट करण्याऐवजी,  
एक random offset — म्हणजेच "jitter" — जोडा:

```
TTL = base_ttl + random(-30, +30)
```

त्यामुळे T=३०० ला expire होणाऱ्या १०,००० keys ऐवजी,  
त्या आता T=२७० ते T=३३० दरम्यान expire होतात.  
तुमच्या database ला एका विनाशकारी spike ऐवजी refresh requests चा एक सुरळीत,  
व्यवस्थापनीय प्रवाह मिळतो.
...
Jitter synchronized expiry समस्या सोडवतो.  
पण अजून एक समस्या आहे:  
key expire झाल्यावर, पुढील request **नेहमीच** serve होण्यापूर्वी पूर्ण recomputation ची वाट बघते.  
जर आपण entry खरोखर expire होण्यापूर्वीच recompute सुरू करू शकलो तर?

**Probabilistic Early Expiration** — ज्याला **XFetch algorithm** असेही म्हणतात — इथेच येते.

### मूळ कल्पना

जसजसे cached value त्याच्या TTL जवळ येते,  
तसतसे वैयक्तिक requests ला background refresh trigger करण्याची वाढती *संभाव्यता* दिली जाते.  
लवकरच्या requests ला कमी शक्यता असते.  
Expiry जवळ येणाऱ्या requests ला खूप जास्त शक्यता असते.

हे एखाद्या जळत्या मेणबत्तीसारखे आहे.  
बहुतेक लोक खोलीचा प्रकाश वापरत राहतात.  
पण मेणबत्ती लहान होत जाताना, कोणीतरी *खोली अंधारात जाण्यापूर्वीच* नवीन मेणबत्ती आणायला जातो.
